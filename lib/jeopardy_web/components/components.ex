defmodule JeopardyWeb.Components do
  ...
  def board(assigns) do
    ~H"""
    <div class="grid grid-cols-6 auto-cols-auto gap-1 text-center font-serif uppercase text-neutral-100 text-shadow">
      <div :for={{category, i} <- Enum.with_index(@categories)} class="grid grid-rows-6 gap-1">
        ...
        <div
          ...
          class="bg-blue-800 p-4 grid place-content-center font-bold font-sans text-3xl"
          style="color: #dda95e"
        >
  ...
  def instructions(assigns) do
    ~H"""
    <div class="bg-sky-50 grid place-content-center w-screen h-screen">
      <div>
