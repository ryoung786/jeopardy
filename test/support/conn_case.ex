defmodule JeopardyWeb.ConnCase do
  ...
  by setting `use JeopardyWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Jeopardy.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Jeopardy.Accounts.generate_user_session_token(user)
