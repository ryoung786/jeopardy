defmodule JeopardyWeb.UserAuthTest do
  use JeopardyWeb.ConnCase

  import Jeopardy.AccountsFixtures

  alias Jeopardy.Accounts
  alias JeopardyWeb.UserAuth
  alias Phoenix.LiveView

  @remember_me_cookie "_jeopardy_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, JeopardyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      JeopardyWeb.Endpoint.subscribe(live_socket_id)
