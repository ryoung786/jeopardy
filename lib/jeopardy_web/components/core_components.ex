defmodule JeopardyWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :warning && "bg-amber-50 text-amber-800 ring-amber-500 fill-cyan-900",
    ...
    >
      <p :if={@title} class="flex items-center gap-1.text-sm font-semibold leading-6">
        ...
        <.icon :if={@kind in [:error, :warning]} name="hero-exclamation-circle-mini" class="h-4 w-4" />
        <%= @title %>
      </p>
